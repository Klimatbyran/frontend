-- Query to get 2024 data with revenue intensity including per million currency intensity
-- Returns all companies with their 2024 emissions and revenue data
...
SELECT
  ...
  -- revenue intensity 2024 per million currency (emissions per million currency units)
  CASE 
    WHEN revenue_2024 IS NOT NULL AND revenue_2024 > 0 
    THEN ROUND(
    ...
    ELSE NULL 
  END AS revenue_intensity_per_million_2024_stated,
  CASE 
    WHEN revenue_2024 IS NOT NULL AND revenue_2024 > 0 
    THEN ROUND(
    ...
    ELSE NULL 
  END AS revenue_intensity_per_million_2024_summed
FROM pivoted
