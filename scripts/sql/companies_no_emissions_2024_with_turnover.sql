...
-- Filters for companies with non-null, non-zero turnover in SEK
-- Includes same columns as 2024_data_with_revenue_intensity query but with turnover terminology
