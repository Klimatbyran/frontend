...
export function DidYouKnow() {
  ...
  const stats = useMemo(() => {
    ...
    const stat4: StatCard = {
      ...
      description: `${companiesMeetingParis.length} out of ${companies.length} companies are on track to meet Paris Agreement goals, demonstrating projected alignment with 1.5°C pathways`,
      bgColor: "bg-orange-4",
    ...
    const stat7: StatCard = {
      ...
      description: `${municipalitiesOnTrack.length} out of ${municipalities.length} municipalities are on track to meet the Paris Agreement goals.`,
      bgColor: "bg-orange-4",
      iconBgColor: "bg-orange-3",
      borderColor: "border-orange-3",
    };
    ...
    const stat8: StatCard = {
      ...
      description: `${avgPerCapitaFormatted}tCO2e/capita is the average municipal emissions per resident, with ${lowestPerCapita?.name || "null"} leading at just ${lowestPerCapita ? formatEmissionsAbsolute(lowestPerCapita.totalConsumptionEmission, currentLanguage) : "null"}/capita`,
      bgColor: "bg-green-4",
      iconBgColor: "bg-green-3",
      borderColor: "border-green-3",
    };
