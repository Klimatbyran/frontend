...
function calculateBackgroundColor(
  ...
  if (
    ...
    // If more than half of the edge pixels have the same colors, then that color is assumed to be the backgroud color
...
function contrast(rgb1: Color, rgb2: Color) {
  // Calculates contrast using formula found at https://www.w3.org/TR/2008/REC-WCAG20-20081211/#contrast-ratiodef
