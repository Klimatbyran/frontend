...
function buildCompanyInsightsPanels(
  ...
  const parisListsBarMax = isMeetsParisKpiSelected
    ? getParisEmitterListsBarMax(companyData)
    : undefined;
  const parisEmissionsDistributionStats = isMeetsParisKpiSelected
    ? getParisEmissionsDistributionStats(companyData, t)
  ...
  return {
    stats: (
      <KPIDetailsPanel
        ...
        chart={
          isMeetsParisKpiSelected ? (
            <MeetsParisEmissionsPieChart
        ...
        distributionStats={parisEmissionsDistributionStats}
