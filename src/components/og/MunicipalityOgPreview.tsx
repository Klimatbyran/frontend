/**
 * OG Image Preview Component for Municipalities
 * Renders a curated preview that looks like the actual municipality detail page
 * Optimized for 1200x630px (Open Graph standard)
 */

import type { Municipality } from "@/types/municipality";

interface MunicipalityOgPreviewProps {
...
export function MunicipalityOgPreview({
  municipality,
  latestYear,
  totalEmissions,
  emissionsChange,
}: MunicipalityOgPreviewProps) {
