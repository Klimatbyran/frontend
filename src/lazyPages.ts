...
export const EuropeanOverviewPage = lazy(() =>
  import("./pages/EuropeanOverviewPage").then((m) => ({
    default: m.EuropeanOverviewPage,
  })),
);
export const EuropeanCountryDetailPage = lazy(() =>
  import("./pages/EuropeanCountryDetailPage").then((m) => ({
    default: m.EuropeanCountryDetailPage,
  })),
);
